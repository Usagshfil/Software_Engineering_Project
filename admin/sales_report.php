                ...
                <table class="table table-bordered" id='report-list'>
                    ...
                    <tbody>
                      ...
                      while($row = $orders->fetch_array()):
                        $items = $conn->query("SELECT o.*,b.name  FROM order_list o inner join products b on b.id=o.order_id where o.order_id = {$row['id']} ");
                      ...
                      <tr>
                        ...
                        <td>
                            <p class="text-right"> <b><?php echo ucwords($roww['name']) ?></b></p>
                        </td>
                        <td>
...
$('#print').click(function(){
        ...
        nw.document.write('<p class="text-center"><b>Tech Store Sales Report as of <?php echo date("F, Y",strtotime($month)) ?></b></p>')
