...
<div class="container-fluid">
	<form action="" id="manage-book">
		...
		<div class="col-lg-12">
					<b class="text-muted">Product Informations</b>
			<div class="row">
				<div class="col-md-6 border-right">
					...
					<div class="form-group">
						<label class="label control-label">Brand</label>
						<input type="text" class="form-control form-control-sm w-100" name="brand" required="" value="<?php echo isset($brand) ? $brand : '' ?>">
					</div>
					<div class="form-group">
